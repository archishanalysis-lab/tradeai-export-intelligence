...
const seed = async () => {
    ...
    const buyers = await Buyer.create([
        ...
        {
            companyName: "Kigali Specialty Retail Collective",
            country: "Rwanda",
            industry: "Specialty retail and SME distribution",
            products: ["packaged foods", "personal care", "light household goods"],
            contactEmail: "category@kigali-specialty.example",
            verified: false,
            tradeVolume: 520000,
            source: "trade_data",
            organizationId: organization._id,
    ...
    const products = await Product.create([
        ...
        {
            name: "Cotton Home Textiles",
            category: "Textiles",
            hsCode: "6302",
            moq: 800,
            price: { amount: 4.75, currency: "USD" },
            exportCountry: "India",
            targetCountries: ["UAE", "Saudi Arabia", "Oman", "Qatar"],
            tags: ["home textiles", "cotton", "hospitality"],
            keywords: ["cotton", "linens", "textiles"],
            availability: "available",
            approvalStatus: "approved",
            organizationId: organization._id,
            createdBy: exporter._id,
        ...
        {
            name: "Light Engineering Components",
            category: "Engineering goods",
            hsCode: "8483",
            moq: 100,
            price: { amount: 18, currency: "USD" },
            exportCountry: "India",
            targetCountries: ["Kenya", "Tanzania", "UAE", "China"],
            tags: ["engineering", "components", "industrial"],
            keywords: ["engineering", "machinery", "components"],
        ...
        {
            name: "Generic Pharmaceutical Inputs",
            category: "Pharma and healthcare",
            hsCode: "3004",
            moq: 50,
            price: { amount: 12, currency: "USD" },
            exportCountry: "India",
            targetCountries: ["Kenya", "Uganda", "Rwanda", "Tanzania"],
            tags: ["pharma", "healthcare", "regulated"],
    ...
    await DemoIntelligence.create(
        [
            ["Kenya", "India to Kenya", "Food, spices, FMCG and light engineering", "0910"],
            ["Tanzania", "India to Tanzania", "FMCG, packaging, machinery and pharma-adjacent categories", "3004"],
            ["Uganda", "India to Uganda", "Food, wellness, personal care and textiles", "0910"],
            ["Rwanda", "India to Rwanda", "Specialty retail, packaged foods and household goods", "6302"],
            ["UAE", "India to UAE", "Premium food, spices, textiles and re-export categories", "0901"],
            ["Saudi Arabia", "India to Saudi Arabia", "Foodservice, packaged foods and construction-linked categories", "1006"],
            ["Oman", "India to Oman", "Retail distribution, food, textiles and hospitality categories", "6302"],
            ["Qatar", "India to Qatar", "Hospitality procurement, premium foods and construction-linked demand", "1006"],
            ["China", "India-China", "Sourcing intelligence, industrial inputs and supplier comparison", "8483"],
        ].map(([country, corridor, sector, hsCode]) => ({
            type: "corridor_insight",
            title: `${corridor} MVP sample corridor intelligence`,
            corridor,
            country,
            sector,
            hsCode,
            sourceLabel: "TradeAI seeded MVP sample intelligence",
            summary: `${country} is included as a sample target market for MVP workflow testing. This is not live verified trade intelligence.`,
            signals: [
                "Use this seed record to test dashboard, report and admin review flows.",
                "Validate live trade data, buyer identity and compliance before commercial outreach.",
            ],
            challenges: [
                "Seeded data is for MVP preview only.",
                "Buyer and compliance claims require verification before launch.",
            ],
            suggestedActions: [
                "Create an export opportunity report.",
                "Review buyer/distributor categories.",
                "Confirm HS code and documentation needs.",
            ],
            isDemo: true,
        })),
    );
